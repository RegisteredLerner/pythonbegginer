...
print("We sold {red} red color,{green} green color, {yellow} yellow color, {white} white color, {black} black color, {blue} blue color, {purple} purple color".format(red=color_count('red'),yellow=color_count('yellow'),green=color_count('green'),white=color_count('white'),black=color_count('black'),blue=color_count('blue'),purple=color_count('purple')))